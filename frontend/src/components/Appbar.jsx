...
export const Appbar = () => {
    ...
    const fetchUserData = async () => {
      try {
        ...
        if (token) {
          ...
          setCurrentUser(response.data.firstName); // Assuming the API returns user's first name
        }
      } catch (error) {
  ...
  return (
    <div className="shadow-md h-16 flex justify-between items-center bg-white relative">
